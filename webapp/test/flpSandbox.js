		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comiffcomaintainmasterdata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comiffcomaintainmasterdata-display": {
								"semanticObject": "comiffcomaintainmasterdata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.iffco.maintainmasterdata",
									"url": sap.ui.require.toUrl("com/iffco/maintainmasterdata")
								}
							}
						}
					}
